...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		{
			List<Integer> neighbor1 = getNeighbors(i);
			List<Integer> neighbor2 = getNeighbors(i);
			result.add(neighbor1.size()+neighbor2.size());
		}
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/utc.map", "data/intersections/utc.intersections");
...
//		
		...
		{
			System.out.println(i+": "+listGraph.getDistance2(i));
		}
		System.out.println("***************");
		...
		{
			System.out.println(i+": "+matrixGraph.getDistance2(i));
		}
	}
}
